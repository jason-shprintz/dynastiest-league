  ...
  return (
    <div style={{ padding: "20px", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: "20px", padding: "10px", border: "1px solid #ccc" }}>
        ...
        {store.leagueStore.error && <p style={{ color: "red" }}>Error: {store.leagueStore.error}</p>}
        {store.leagueStore.league && (
          <div>
            <p><strong>Name:</strong> {store.leagueStore.league.name}</p>
            <p><strong>Season:</strong> {store.leagueStore.league.season}</p>
            <p><strong>Total Rosters:</strong> {store.leagueStore.league.total_rosters}</p>
            <p><strong>Status:</strong> {store.leagueStore.league.status}</p>
          </div>
        )}
      </div>
      ...
      <div style={{ marginBottom: "20px", padding: "10px", border: "1px solid #ccc" }}>
        ...
        {store.rostersStore.error && <p style={{ color: "red" }}>Error: {store.rostersStore.error}</p>}
      ...
      <div style={{ marginBottom: "20px", padding: "10px", border: "1px solid #ccc" }}>
        ...
        {store.usersStore.error && <p style={{ color: "red" }}>Error: {store.usersStore.error}</p>}
      ...
      <div style={{ marginBottom: "20px", padding: "10px", border: "1px solid #ccc" }}>
        ...
        {store.matchupsStore.error && <p style={{ color: "red" }}>Error: {store.matchupsStore.error}</p>}
        {store.matchupsStore.getMatchupsForWeek(1).length > 0 && (
          <p>Loaded {store.matchupsStore.getMatchupsForWeek(1).length} matchups</p>
        )}
      </div>
      ...
      <div style={{ marginBottom: "20px", padding: "10px", border: "1px solid #ccc" }}>
        ...
        {store.draftStore.error && <p style={{ color: "red" }}>Error: {store.draftStore.error}</p>}
        {store.draftStore.drafts.length > 0 && (
          <div>
            <p>Loaded {store.draftStore.drafts.length} draft(s)</p>
            {store.draftStore.mostRecentDraft && (
              <p><strong>Most Recent Draft:</strong> {store.draftStore.mostRecentDraft.draft_id}</p>
            )}
          </div>
        )}
      </div>
      ...
      <div style={{ marginBottom: "20px", padding: "10px", border: "1px solid #ccc" }}>
        ...
        {store.playoffsStore.error && <p style={{ color: "red" }}>Error: {store.playoffsStore.error}</p>}
        {store.playoffsStore.bracket.length > 0 && (
          <p>Loaded {store.playoffsStore.bracket.length} playoff matchup(s)</p>
        )}
      </div>
      ...
      <div style={{ marginBottom: "20px", padding: "10px", border: "1px solid #ccc" }}>
        ...
        {store.transactionsStore.error && <p style={{ color: "red" }}>Error: {store.transactionsStore.error}</p>}
        {store.transactionsStore.getTransactionsForWeek(1).length > 0 && (
          <p>Loaded {store.transactionsStore.getTransactionsForWeek(1).length} transaction(s)</p>
        )}
      </div>
      ...
      <div style={{ marginBottom: "20px", padding: "10px", border: "1px solid #ccc" }}>
        ...
        {store.tradedPicksStore.error && <p style={{ color: "red" }}>Error: {store.tradedPicksStore.error}</p>}
        {store.tradedPicksStore.tradedPicks.length > 0 && (
          <p>Loaded {store.tradedPicksStore.tradedPicks.length} traded pick(s)</p>
        )}
      </div>
    </div>
  );
